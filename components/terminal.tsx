        ...
        output: (
          <div className="space-y-2">
            ...
            <p className="font-mono text-white">
              Welcome to Tushir Sahu's portfolio! Type help to see available commands.
            </p>
          </div>
        ),
        timestamp: new Date(),
        ...
        output = (
          <div className="space-y-2 text-white">
            ...
            <ul className="space-y-1">
              <li>
                <span className="text-white font-bold">about</span> - Learn about Tushir
              </li>
              <li>
              ...
              <li>
                <span className="text-white font-bold">certifications</span> - View courses and leadership highlights
              </li>
              <li>
...
`}
            ...
            <p className="text-green-500">Scan complete! All systems ready.</p>
          </div>
        )
        setCurrentSection(null)
        break
    ...
    <div className="flex flex-col h-full">
      <div className="bg-black border border-white/30 rounded-t-md p-2 flex items-center">
        ...
        <span className="text-sm font-mono text-white">
          tushir@portfolio ~ {currentSection ? `/${currentSection}` : ""}
        </span>
      </div>
